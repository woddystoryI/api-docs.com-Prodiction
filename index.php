...
<link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700&amp;subset=latin,cyrillic-ext,latin-ext" rel="stylesheet" type="text/css">
	 	...
	 	<div class="page-content">
			...
			<div class="breadcrumb-line breadcrumb-top">
				<ul class="breadcrumb">
					...
					<li class="active"><?php echo $lang['MENU_INTRODUCTION']; ?></li>
				</ul>
        ...
        <ul class="breadcrumb-buttons collapse" id="on-top">
          <li class="language dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right icons-right">
              ...
              <li class="active"><a href="index.php?lang=en"><img src="images/flags/english.png" alt=""> English</a></li>
              <li class="active"><a href="index.php?lang=pt"><img src="images/flags/portuguese.png" alt=""> Portuguese</a></li>
			  			  
			  <li class="disabled"><a href="index.php?lang=ko"><img src="images/flags/korean.png" alt=""> Korean</a></li>
			  <li class="disabled"><a href="index.php?lang=cn"><img src="images/flags/china.png" alt=""> Chinese</a></li>
			...
			<div class="page-header">
				<div class="page-title">
					<h3><i class="icon-bubbles"></i><?php echo $lang['MENU_INTRODUCTION']; ?></h3>
				</div>
			...
			<?php echo $lang['INTRO_INTRO']; ?><br><br>

- <?php echo $lang['INTRO_USERS']; ?><br>
- <?php echo $lang['INTRO_DEVS']; ?><br><br>

<?php echo $lang['INTRO_PARAGRAPH1']; ?><br>
<br>
<?php echo $lang['INTRO_PARAGRAPH2']; ?><br><br><br>

	       
	<!-- Callout -->
			<div class="callout callout-success fade in">
				<p><i class="icon-lamp3"></i>&nbsp;&nbsp;<?php echo $lang['INTRO_VERSION']; ?></p>
			</div>
            <!-- /callout -->
