        ...
        <ul class="breadcrumb-buttons collapse" id="on-top">
          <li class="language dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right icons-right">
              ...
              <li class="active"><a href="prodiction.php?lang=en"><img src="images/flags/english.png" alt=""> English</a></li>
              <li class="active"><a href="prodiction.php?lang=pt"><img src="images/flags/portuguese.png" alt=""> Portuguese</a></li>
			  			  
			  <li class="disabled"><a href="prodiction.php?lang=ko"><img src="images/flags/korean.png" alt=""> Korean</a></li>
			  <li class="disabled"><a href="prodiction.php?lang=cn"><img src="images/flags/china.png" alt=""> Chinese</a></li>
