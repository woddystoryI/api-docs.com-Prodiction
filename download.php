        ...
        <ul class="breadcrumb-buttons collapse" id="on-top">
          <li class="language dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right icons-right">
              ...
              <li class="active"><a href="download.php?lang=en"><img src="images/flags/english.png" alt=""> English</a></li>
			...
			<div class="page-header">
				<div class="page-title">
					<h3><i class="icon-lightning"></i><?php echo $lang['DOWNLOAD_DOWNLOAD']; ?></h3>
				</div>

				
			</div>
			
			<h6><i class="icon-stats-up"></i><?php echo $lang['DOWNLOAD_UPCOMMING_UPDATES'] ?></h6>
				...
				<div class="panel panel-default" style="border: 1px solid rgb(100, 149, 237);">
                  <div class="panel-heading" style="background-color: rgb(135, 206, 250);">
                    <h6 class="panel-title panel-trigger"><a data-toggle="collapse" href="#question1" class="collapsed"><?php echo $lang['DOWNLOAD_VERSION']; ?> 1.5</a></h6>
                  </div>
                  <div id="question1" class="panel-collapse collapse" style="height: 0px;">
						<div class="panel-group" id="accordion-color" style="max-width: 675px;float: left;width: 100%;">
						  <div class="tabbable">
							<ul class="nav nav-tabs">
							  <li class="active"><a href="#iconified-tab1" data-toggle="tab"><i class="icon-code"></i><?php echo $lang['DOWNLOAD_FEATURES']; ?></a></li>
							  <li><a href="#iconified-tab2" data-toggle="tab"><i class="icon-notification"></i> <?php echo $lang['DOWNLOAD_TO_DO']; ?></a></li>
							</ul>
							<div class="tab-content with-padding">
							  <div class="tab-pane fade in active" id="iconified-tab1">
								<ul>
								  <li><?php echo $lang['DOWNLOAD_U_LINE_1']; ?></li>
								  <li><?php echo $lang['DOWNLOAD_U_LINE_2']; ?></li>
								  <li><?php echo $lang['DOWNLOAD_U_LINE_3']; ?></li>
								  <li><?php echo $lang['DOWNLOAD_U_LINE_4']; ?></li>
								</ul>
							  </div>

							  <div class="tab-pane fade" id="iconified-tab2">
							  <?php echo $lang['DOWNLOAD_U_TO_DO']; ?>
							  </div>
							</div>
						  </div>
						</div>
						<div class="" style="padding: 16px 0px 19px 11px;float:right;width: 170px;margin: 19px 13px 0px 0px;border-left: 1px solid rgb(223, 223, 223);">
							<a href="bugreport.php" style="height: 34px;float: right;width: 100%;" type="button" class="btn btn-info"><i class="icon-wink"></i> <?php echo $lang['DOWNLOAD_U_SUGESTION']; ?></a>
					</div>
				...
				<br><br>
				<h6><i class="icon-stats-up"></i> <?php echo $lang['DOWNLOAD_CURRENT_VERSION']; ?></h6>
				<div class="panel-group block2">
				<div class="panel panel-default" style="border: 1px solid rgb(26, 178, 50);">
                  <div class="panel-heading"  style="background-color: rgb(206, 235, 206);">
                    <h6 class="panel-title panel-trigger active"><a data-toggle="collapse" href="#currentv" class="collapsed"><?php echo $lang['DOWNLOAD_VERSION']; ?> 1.4</a></h6>
                  </div>
                  <div id="currentv" class="panel-collapse collapse in" style="height: auto;">
						  ...
						  <div class="tabbable">
							<ul class="nav nav-tabs">
							  <li class="active"><a href="#iconified-tab1-c" data-toggle="tab"><i class="icon-code"></i> <?php echo $lang['DOWNLOAD_CHANGELOG']; ?></a></li>
							  <li><a href="#iconified-tab2-c" data-toggle="tab"><i class="icon-notification"></i> <?php echo $lang['DOWNLOAD_KNOWN_ISSUES']; ?></a></li>
							</ul>
							<div class="tab-content with-padding">
							  <div class="tab-pane fade in active" id="iconified-tab1-c">
								  <ul>
									 <li><?php echo $lang['DOWNLOAD_C_LINE_1']; ?></li>
								  <li><?php echo $lang['DOWNLOAD_C_LINE_2']; ?></li>
								  <li><?php echo $lang['DOWNLOAD_C_LINE_3']; ?></li>
									</ul>
							  </div>
                    ...
                    <div style="text-align: center;padding: 10px;background-color: rgb(244, 248, 250);margin-bottom: 10px;">
						<div><i class="icon-notification"></i> <?php echo $lang['DOWNLOAD_C_RELEASE_DATE']; ?> </div>
					</div>
					<p class="alert alert-success fade in text-center">
                        <?php echo $lang['DOWNLOAD_QUESTIONS1']; ?><a href="bugreport.php"> <?php echo $lang['DOWNLOAD_QUESTIONS2']; ?> </a> <?php echo $lang['DOWNLOAD_QUESTIONS3']; ?>
					</p>
				...
				<br><br>
				<h6><i class="icon-stats-up"></i> <?php echo $lang['DOWNLOAD_OLD_VERSIONS']; ?></h6>
				<div class="panel-group block2">
				<div class="panel panel-default" style="border: 1px solid rgb(178, 26, 26);">
                  <div class="panel-heading"  style="background-color: rgb(236, 200, 200);">
                    <h6 class="panel-title panel-trigger"><a data-toggle="collapse" href="#old11" class="collapsed"><?php echo $lang['DOWNLOAD_VERSION']; ?> 1.3</a></h6>
                  </div>
                  <div id="old11" class="panel-collapse collapse" style="height: 0px;">
													<div class="panel-group" id="accordion-color" style="max-width: 675px;float: left;width: 100%;margin-botton:9px">
						  <div class="tabbable">
							<ul class="nav nav-tabs">
							  <li class="active"><a href="#iconified-tab1-c11" data-toggle="tab"><i class="icon-code"></i> <?php echo $lang['DOWNLOAD_CHANGELOG']; ?></a></li>
							  <li><a href="#iconified-tab2-c11" data-toggle="tab"><i class="icon-notification"></i> <?php echo $lang['DOWNLOAD_KNOWN_ISSUES']; ?></a></li>
							</ul>
							<div class="tab-content with-padding">
							  <div class="tab-pane fade in active" id="iconified-tab1-c11">
								  <ul>
									<li><?php echo $lang['DOWNLOAD_O_LINE1_1.3']; ?></li>
									   <li><?php echo $lang['DOWNLOAD_O_LINE2_1.3']; ?></li>
									</ul>
							  </div>
					...
					<div class="" style="padding: 16px 0px 19px 11px;float:right;width: 170px;margin: 19px 13px 0px 0px;border-left: 1px solid rgb(223, 223, 223);">
						...
						<div class="" style="padding-left: 10px!important;margin-bottom: 12px;float:left;width: 100%;margin-top: 9px;padding-right: 10px;border-top: 1px solid rgb(221, 221, 221);padding-top: 12px;">
                    <div style="text-align: center;padding: 10px;background-color: rgb(244, 248, 250);margin-bottom: 10px;">
						<div><i class="icon-notification"></i> <?php echo $lang['DOWNLOAD_RELEASE_1.3']; ?> </div>
					</div>
					<p class="alert alert-success fade in text-center">
                       <?php echo $lang['DOWNLOAD_QUESTIONS1']; ?><a href="bugreport.php"> <?php echo $lang['DOWNLOAD_QUESTIONS2']; ?> </a> <?php echo $lang['DOWNLOAD_QUESTIONS3']; ?>
					</p>
				...
				<div class="panel panel-default" style="border: 1px solid rgb(178, 26, 26);">
                  <div class="panel-heading"  style="background-color: rgb(236, 200, 200);">
                    <h6 class="panel-title panel-trigger"><a data-toggle="collapse" href="#old11" class="collapsed"><?php echo $lang['DOWNLOAD_VERSION']; ?> 1.2</a></h6>
                  </div>
                  <div id="old11" class="panel-collapse collapse" style="height: 0px;">
													<div class="panel-group" id="accordion-color" style="max-width: 675px;float: left;width: 100%;margin-botton:9px">
						  <div class="tabbable">
							...
							<div class="tab-content with-padding">
							  <div class="tab-pane fade in active" id="iconified-tab1-c11">
								  <ul>
									 <li><?php echo $lang['DOWNLOAD_O_LINE1_1.2']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE2_1.2']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE3_1.2']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE4_1.2']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE5_1.2']; ?></li>
									</ul>
							  </div>
							  <div class="tab-pane fade" id="iconified-tab2-c11">
					...
					<div class="" style="padding: 16px 0px 19px 11px;float:right;width: 170px;margin: 19px 13px 0px 0px;border-left: 1px solid rgb(223, 223, 223);">
						...
						<div class="" style="padding-left: 10px!important;margin-bottom: 12px;float:left;width: 100%;margin-top: 9px;padding-right: 10px;border-top: 1px solid rgb(221, 221, 221);padding-top: 12px;">
                    <div style="text-align: center;padding: 10px;background-color: rgb(244, 248, 250);margin-bottom: 10px;">
						<div><i class="icon-notification"></i> <?php echo $lang['DOWNLOAD_RELEASE_1.2']; ?>  </div>
					</div>
					<p class="alert alert-success fade in text-center">
                        <?php echo $lang['DOWNLOAD_QUESTIONS1']; ?><a href="bugreport.php"> <?php echo $lang['DOWNLOAD_QUESTIONS2']; ?> </a> <?php echo $lang['DOWNLOAD_QUESTIONS3']; ?>
					</p>
				...
				<div class="panel panel-default" style="border: 1px solid rgb(178, 26, 26);">
                  <div class="panel-heading"  style="background-color: rgb(236, 200, 200);">
                    <h6 class="panel-title panel-trigger"><a data-toggle="collapse" href="#old11" class="collapsed"><?php echo $lang['DOWNLOAD_VERSION']; ?> 1.1a</a></h6>
                  </div>
                  <div id="old11" class="panel-collapse collapse" style="height: 0px;">
													<div class="panel-group" id="accordion-color" style="max-width: 675px;float: left;width: 100%;margin-botton:9px">
						  <div class="tabbable">
							...
							<div class="tab-content with-padding">
							  <div class="tab-pane fade in active" id="iconified-tab1-c11">
								  <ul>
									  <li><?php echo $lang['DOWNLOAD_O_LINE1_1.1a']; ?></li>
				...
				<div class="panel panel-default" style="border: 1px solid rgb(178, 26, 26);">
                  <div class="panel-heading"  style="background-color: rgb(236, 200, 200);">
                    <h6 class="panel-title panel-trigger"><a data-toggle="collapse" href="#old11" class="collapsed"><?php echo $lang['DOWNLOAD_VERSION']; ?> 1.1</a></h6>
                  </div>
                  <div id="old11" class="panel-collapse collapse" style="height: 0px;">
													<div class="panel-group" id="accordion-color" style="max-width: 675px;float: left;width: 100%;margin-botton:9px">
						  <div class="tabbable">
							...
							<div class="tab-content with-padding">
							  <div class="tab-pane fade in active" id="iconified-tab1-c11">
								  <ul>
									  <li><?php echo $lang['DOWNLOAD_O_LINE1_1.1']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE2_1.1']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE3_1.1']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE4_1.1']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE5_1.1']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE6_1.1']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE7_1.1']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE8_1.1']; ?></li>
									  <li><?php echo $lang['DOWNLOAD_O_LINE9_1.1']; ?> http://www.api-docs.com/prodiction/prodiction.php</li>
									</ul>
							  </div>
							  <div class="tab-pane fade" id="iconified-tab2-c11">
					...
					<div class="" style="padding: 16px 0px 19px 11px;float:right;width: 170px;margin: 19px 13px 0px 0px;border-left: 1px solid rgb(223, 223, 223);">
						...
						<div class="" style="padding-left: 10px!important;margin-bottom: 12px;float:left;width: 100%;margin-top: 9px;padding-right: 10px;border-top: 1px solid rgb(221, 221, 221);padding-top: 12px;">
                    <div style="text-align: center;padding: 10px;background-color: rgb(244, 248, 250);margin-bottom: 10px;">
						<div><i class="icon-notification"></i> <?php echo $lang['DOWNLOAD_RELEASE_1.1']; ?>  </div>
					</div>
					<p class="alert alert-success fade in text-center">
                        <?php echo $lang['DOWNLOAD_QUESTIONS1']; ?><a href="bugreport.php"> <?php echo $lang['DOWNLOAD_QUESTIONS2']; ?> </a> <?php echo $lang['DOWNLOAD_QUESTIONS3']; ?>
					</p>
				...
				<div class="panel panel-default" style="border: 1px solid rgb(178, 26, 26);">
                  <div class="panel-heading"  style="background-color: rgb(236, 200, 200);">
                    <h6 class="panel-title panel-trigger"><a data-toggle="collapse" href="#old1" class="collapsed"><?php echo $lang['DOWNLOAD_VERSION']; ?> 0.3</a></h6>
                  </div>
                  <div id="old1" class="panel-collapse collapse" style="height: 0px;">
													<div class="panel-group" id="accordion-color" style="max-width: 675px;float: left;width: 100%;margin-botton:9px">
						  <div class="tabbable">
							<ul class="nav nav-tabs">
							  <li class="active"><a href="#iconified-tab1-c3" data-toggle="tab"><i class="icon-code"></i> <?php echo $lang['DOWNLOAD_CHANGELOG']; ?></a></li>
							  <li><a href="#iconified-tab2-c3" data-toggle="tab"><i class="icon-notification"></i> <?php echo $lang['DOWNLOAD_KNOWN_ISSUES']; ?></a></li>
							</ul>
							<div class="tab-content with-padding">
							  <div class="tab-pane fade in active" id="iconified-tab1-c3">
								<p class="alert alert-danger fade in text-center">
                        <?php echo $lang['DOWNLOAD_O_WARNING_0.3']; ?>
					</p>
							  </div>
							  <div class="tab-pane fade" id="iconified-tab2-c3">
							  	 <p class="alert alert-danger fade in text-center">
                        <?php echo $lang['DOWNLOAD_O_WARNING_0.3']; ?>
					</p>
							  </div>
