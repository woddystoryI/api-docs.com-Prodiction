	 	...
	 	<div class="page-content">
			...
			<div class="breadcrumb-line breadcrumb-top">
				<ul class="breadcrumb">
					...
					<li class="active"><?php echo $lang['MENU_INFO']; ?></li>
				</ul>
        ...
        <ul class="breadcrumb-buttons collapse" id="on-top">
          <li class="language dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right icons-right">
              ...
              <li class="active"><a href="info.php?lang=en"><img src="images/flags/english.png" alt=""> English</a></li>
              <li class="active"><a href="info.php?lang=pt"><img src="images/flags/portuguese.png" alt=""> Portuguese</a></li>
			  			  
			  <li class="disabled"><a href="info.php?lang=ko"><img src="images/flags/korean.png" alt=""> Korean</a></li>
			  <li class="disabled"><a href="info.php?lang=cn"><img src="images/flags/china.png" alt=""> Chinese</a></li>
			...
			<div class="page-header">
				<div class="page-title">
					<h3><i class="icon-lightning"></i><?php echo $lang['MENU_INFO']; ?></h3>
				</div>
			...
			<!-- Bordered table -->
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table2"></i> Info</h6></div>
			                <div class="table-responsive">
				                <table class="table table-bordered ">
				                    ...
				                    <tbody>
				                    	<tr>
				                            <td ><a class="scrolle" href="#collision">collision((opt)filter)</a><span style='float:right;' class="label label-danger">Change 1.1</span></td>
				                            <td class="text-center">Boolean</td>
				                        </tr>
				                        <tr>
				                            <td >mCollision((opt)filter)<span style='float:right;' class="label label-danger">Change 1.1</span></td>
				                            <td class="text-center">Boolean</td>
				                        </tr>
				                        <tr>
				                            <td >hCollision((opt)filter)<span style='float:right;' class="label label-danger">Change 1.1</span></td>
				                            <td class="text-center">Boolean</td>
				                        </tr>
				                    </tbody>
				                    <thead>
				                        <tr>
				                            <th >Properties</th>
				                            <th style="width:200px;" class="text-center">Value</th>
				                        </tr>
				                    </thead>
				                    <tbody>
				                    	 <tr>
				                            <td ><?php echo $lang['MENU_SPELL']; ?><span style='float:right;' class="label label-info">New</span></td>
				                            <td class="text-center"><a href="spell.php"><?php echo $lang['MENU_SPELL']; ?> </a></td>
				                        </tr>
				                        <tr>
				                            <td >type<span style='float:right;' class="label label-info">New</span></td>
				                            <td class="text-center">Integer</td>
				                        </tr>
				                        <tr>
				                            <td >hitchance<span style='float:right;' class="label label-info">New</span></td>
				                            <td class="text-center">Integer</td>
				                        </tr>
				                        <tr>
				                            <td >pos<span style='float:right;' class="label label-info">New</span></td>
				                            <td class="text-center">Vector</td>
				                        </tr>
				                        <tr>
				                            <td >unit<span style='float:right;' class="label label-info">New</span></td>
				                            <td class="text-center">Vector</td>
				                        </tr>
				                    </tbody>
				                </table>
				        ...
				        <hr id='collision'>
			<h6>collision((opt)filter)</h6>
			<br>
			return a boolean if there is collision between source and end position. <br>
			Default value: Enemy Hero and Minions.<br><br>
			<div class="panel panel-default">
				                ...
				                <table class="table table-bordered ">
				                    ...
				                    <tbody>
				                        <tr>
				                            <td >filter</td>
				                            <td >table</td>
				                            <td >To change the object you wanna check on.</td>
				                        </tr>
			                ...
			                <div class="table-responsive">
				                <table class="table table-bordered ">
				                    ...
				                    <tbody>
				                        <tr>
				                            <td >Boolean</td>
				                            <td >return a true if there is a collision.</td>
				                        </tr>
				                        <tr>
				                            <td >objects</td>
				                            <td >return objects that cause the collision</td>
				                        </tr>
				                    </tbody>
				                </table>
			                </div>
