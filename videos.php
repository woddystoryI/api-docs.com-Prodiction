...
$(document).ready(function(){
	...
	$.each( ["api","introduction","download","tutorial"], function( key, value ) {
	 	...
	 	<div class="page-content">
			...
			<div class="breadcrumb-line breadcrumb-top">
				<ul class="breadcrumb">
					...
					<li class="active"><?php echo $lang['MENU_VIDEOS']; ?></li>
				</ul>
        ...
        <ul class="breadcrumb-buttons collapse" id="on-top">
          <li class="language dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right icons-right">
              ...
              <li class="active"><a href="videos.php?lang=en"><img src="images/flags/english.png" alt=""> English</a></li>
              <li class="active"><a href="videos.php?lang=pt"><img src="images/flags/portuguese.png" alt=""> Portuguese</a></li>
			  			  
			  <li class="disabled"><a href="videos.php?lang=ko"><img src="images/flags/korean.png" alt=""> Korean</a></li>
			  <li class="disabled"><a href="videos.php?lang=cn"><img src="images/flags/china.png" alt=""> Chinese</a></li>
			...
			<div class="page-header">
				<div class="page-title">
					<h3><i class="icon-lightning"></i><?php echo $lang['MENU_VIDEOS']; ?></h3>
				</div>
			...
			<div class="callout callout-danger fade in">
				...
				<h5>Error</h5>
				<p>This page will get update soon.</p>
			</div>
