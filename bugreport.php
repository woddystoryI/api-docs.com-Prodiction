...
$(document).ready(function(){
	...
	$.each( ["api","introduction"], function( key, value ) {
		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<div class="breadcrumb-line breadcrumb-top">
				<ul class="breadcrumb">
					<li><a href="index.html"><?php echo $lang['MENU_HOME']; ?></a></li>
					<li class="active"><?php echo $lang['MENU_BUG_REPORT']; ?></li>
				</ul>
        ...
        <ul class="breadcrumb-buttons collapse" id="on-top">
          <li class="language dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right icons-right">
              ...
              <li class="active"><a href="bugreport.php?lang=en"><img src="images/flags/english.png" alt=""> English</a></li>
			...
			<div class="callout callout-danger fade in">
				...
				<h5><?php echo $lang['BUG_ERROR']; ?></h5>
				<p><?php echo $lang['BUG_ERROR_REPORT']; ?></p>
			</div>
            <!-- /callout -->
			<!-- Bug report form -->
			<form action="#" role="form">
	            <div class="panel panel-default">
	                <div class="panel-heading"><h6 class="panel-title"><i class="icon-bug"></i><?php echo $lang['BUG_BUG']; ?></h6></div>
	                <div class="panel-body">

						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									<label><?php echo $lang['BUG_LOGIN']; ?></label>
	                                <input type="text" class="form-control" placeholder="<?php echo $lang['BUG_NAME']; ?>">
								</div>

								<div class="col-md-6">
									<label><?php echo $lang['BUG_EMAIL']; ?></label>
	                                <input type="text" class="form-control" placeholder="<?php echo $lang['BUG_YOUR_EMAIL']; ?>">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								<div class="col-md-6">
									<label><?php echo $lang['BUG_VERSION']; ?></label>
                                    <select data-placeholder="Choose your system..." class="select-full" tabindex="2">
                                        <option value="win7">1.0 Nighty</option>
									<!--<option value="win7">1.1 Nighty</option>
										<option value="win7">1.1 Stable</option> 
										<option value="win7">1.1a Nighty</option> 										
										<option value="win7">1.1a Stable</option> 
										<option value="win7">1.2 Nighty</option> 
										<option value="win7">1.3 Nighty</option>
										<option value="win7">1.3 Stable</option>
										<option value="win7">1.4 Nighty</option> 
										<option value="win7">1.5 Stable</option> -->
                                    </select>
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							<label><?php echo $lang['BUG_INFO']; ?></label>
                            <textarea rows="5" cols="5" placeholder="<?php echo $lang['BUG_PUT_HERE_YOUR_BUG_REPORT']; ?>" class="elastic form-control"></textarea>
						</div>

                        <div class="form-actions text-right">
                        	<input type="submit" value="<?php echo $lang['BUG_SUBMIT_REPORT']; ?>" class="btn btn-primary">
                        </div>
