	 	...
	 	<div class="page-content">
			...
			<div class="breadcrumb-line breadcrumb-top">
				<ul class="breadcrumb">
					...
					<li class="active"><?php echo $lang['MENU_SPELL']; ?></li>
				</ul>
        ...
        <ul class="breadcrumb-buttons collapse" id="on-top">
          <li class="language dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-right icons-right">
              ...
              <li class="active"><a href="spell.php?lang=en"><img src="images/flags/english.png" alt=""> English</a></li>
              <li class="active"><a href="spell.php?lang=pt"><img src="images/flags/portuguese.png" alt=""> Portuguese</a></li>
			  			  
			  <li class="disabled"><a href="spell.php?lang=ko"><img src="images/flags/korean.png" alt=""> Korean</a></li>
			  <li class="disabled"><a href="spell.php?lang=cn"><img src="images/flags/china.png" alt=""> Chinese</a></li>
			...
			<div class="page-header">
				<div class="page-title">
					<h3><i class="icon-lightning"></i><?php echo $lang['MENU_SPELL']; ?></h3>
				</div>
			...
			<!-- Bordered table -->
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table2"></i> Spell</h6></div>
			                <div class="table-responsive">
				                <table class="table table-bordered ">
				                    ...
				                    <tbody>
				                    	 <tr>
				                            <td >range<span style='float:right;' class="label label-info">New</span></td>
				                            <td class="text-center">Integer</td>
				                        </tr>
				                        <tr>
				                            <td >speed<span style='float:right;' class="label label-info">New</span></td>
				                            <td class="text-center">Integer</td>
				                        </tr>
				                       
				                        <tr>
				                            <td >delay<span style='float:right;' class="label label-info">New</span></td>
				                            <td class="text-center">Integer</td>
				                        </tr>
				                        <tr>
				                            <td >width<span style='float:right;' class="label label-info">New</span></td>
				                            <td class="text-center">Integer</td>
				                        </tr>
				                        <tr>
				                            <td >source<span style='float:right;' class="label label-info">New</span></td>
